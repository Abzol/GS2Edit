...
/*
TODO: The 0x08...... address prefix
    The original author of this code kept reading from the 0x08...... range.
    This is prevalent on every static address in this code.
    The file being read is only 0xFFFFFF big. However, it's loaded at
    location 0x08000000 on the original GBA hardware. The original author
    for one reason or another didn't think to just skip that.
    Remove all unneccessary hardware-accurate addresses to instead directly
    target accurate offsets in the file if no complications appear.
*/
